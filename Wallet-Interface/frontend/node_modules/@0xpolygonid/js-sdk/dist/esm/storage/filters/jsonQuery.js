 ...
 */
export const resolvePath = (object, path, defaultValue = null) => path.split('.').reduce((o, p) => (o ? o[p] : defaultValue), object);
/**
 ...
 */
export const createFilter = (path, operatorFunc, value, isReverseParams = false) => {
    if (!operatorFunc) {
