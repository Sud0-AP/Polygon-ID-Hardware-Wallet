...
exports.StandardJSONCredentialsQueryFilter = exports.FilterQuery = exports.createFilter = exports.resolvePath = exports.comparatorOptions = exports.SearchError = void 0;
/**
 * search errors
 *
 * @export
 ...
 */
const resolvePath = (object, path, defaultValue = null) => path.split('.').reduce((o, p) => (o ? o[p] : defaultValue), object);
 ...
 */
const createFilter = (path, operatorFunc, value, isReverseParams = false) => {
    if (!operatorFunc) {
        throw new Error(SearchError.NotDefinedComparator);
    }
    return (credential) => {
        const credentialPathValue = (0, exports.resolvePath)(credential, path);
